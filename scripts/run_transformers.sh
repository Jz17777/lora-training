...
# Transformers LoRA 训练脚本
# 使用方法: bash scripts/run_transformers.sh [配置文件路径]

# 设置默认配置文件路径
CONFIG_FILE="${1:-configs/transformers/qwen3_8b_lora.yaml}"
...
nohup python -u transformers/train_sft.py --config "$CONFIG_FILE" > "$LOG_FILE" 2>&1 &
